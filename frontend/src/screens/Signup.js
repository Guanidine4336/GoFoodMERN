...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://gofoodmern-uwa5.onrender.com/api/CreateUser", {
      method: 'POST',
      headers: {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch("https://gofoodmern-uwa5.onrender.com/api/getlocation", {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
